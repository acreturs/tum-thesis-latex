...
\newcommand*{\getTitle}{Generalizing Knowlede}
\newcommand*{\getTitleGer}{Titel der Abschlussarbeit}
\newcommand*{\getAuthor}{Author}
\newcommand*{\getDoctype}{Bachelor's Thesis}
\newcommand*{\getSupervisor}{Larkin Lio}
\newcommand*{\getAdvisor}{Liu}
\newcommand*{\getKeywords}{Ai}
\newcommand*{\getSubmissionDate}{16.March.2025}
